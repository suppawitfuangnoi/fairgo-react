  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background-light dark:bg-background-dark font-display relative overflow-hidden h-screen flex items-center justify-center">
        ...
        <div className="fixed top-0 left-0 right-0 z-[9998] pt-12 pb-4 px-6 flex justify-between items-start pointer-events-none">
        ...
        {/* Bottom Sheet Area */}
        <div className="fixed bottom-0 left-0 right-0 z-[9999] flex flex-col max-h-[70vh]">
