...
export default function OnboardingPage() {
  ...
  return (
    <div className="w-full max-w-md h-screen max-h-[844px] mx-auto bg-background-light dark:bg-background-dark shadow-2xl overflow-hidden flex flex-col relative">
      {/* Status Bar */}
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 pt-10 pb-24">
        ...
        <div className="relative w-full aspect-square mb-10 flex items-center justify-center">
          ...
          {/* Floating Badge */}
          <div className="absolute bottom-10 -right-2 bg-surface-light dark:bg-surface-dark p-4 rounded-2xl shadow-lg border border-primary/10 flex items-center gap-3 animate-bounce">
        ...
        <div className="text-center w-full max-w-[300px]">
          <h1 className="text-3xl font-bold text-text-main dark:text-white mb-4 leading-tight">
